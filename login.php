      ...
      <div class="wrapper wrapper--w960">
        <div class="card card-2">
          ...
          <div class="card-body">
            ...
            <form  action = "/Main Web Proj/login.php" method="post">
...
if($row['Username'] == $MO_username && $row['Password'] == $MO_password){
    $check = 1;
    break;
}
...
if($check ==1){
    echo '<center style = "position:absolute; left:50%;top:20%;transform:translate(-50%,-50%)"><h3>Login Succesfull</h3></center>';
   }
   else{
       echo '<center style = "position:absolute; left:50%;top:20%;transform:translate(-50%,-50%)"><h3>Incorrect Credentials</h3></center>';
   }
